...
| `lookupButton`                           | No                                | `FormsListStylesButton`             | Optional configuration of the lookup button                                                                                                                                                                                                                                                                                                                              |               |
| `elementLookupId`                        | No                                | `long?`                             | The id of the lookup being applied to this element                                                                                                                                                                                                                                                                                                                       |               |
| `runLookupOnClear`                       | No                                | `long?`                             | Run the lookup when the user clears the input or deselects the option(s).                                                                                                                                                                                                                                                                                                |               |
