...
| `hiddenFrom`                             | No                                | `List<string>`                            | Audiences to hide the element from when `isHidden` is `true`. Omitted means all audiences. Allowed values are `"FORM_COMPLETER"` and `"APPROVER"`.                                                                                                                                                                                                                                         |               |
