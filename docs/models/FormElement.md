...
| `regexValidation`                        | No       | `FormElementRegexValidation`        | Configure input validation using a regular expression with a custom error message (applies to number, text, textarea, email, telephone and barcode scanner elements)                                                                                                                                                                                                                         |               |
