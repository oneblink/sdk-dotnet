...
| `fromDate`                               | No       | `string`                            | The minimum date as an iso string or the constant 'NOW', that can be entered by the user (applies to date and datetime elements)                                                                                                                                                                                                                                  |               |
| `fromDateDaysOffset`                     | No       | `long`                              | The number of days to offset the fromDate value for date and datetime elements                                                                                                                                                                                                                                  |               |
| `toDate`                                 | No       | `string`                            | The maximum date as an iso string or the constant 'NOW', that can be entered by the user (applies to date and datetime elements)                                                                                                                                                                                                                                  |               |
