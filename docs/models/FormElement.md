...
| `approverEditability`                    | No                                | `FormElementApproverEditability`          | Configuration for which approval flow steps may edit the element. Currently, `type` supports `"ALL_STEPS"`.                                                                                                                                                                                                                                                                                |               |
...
| `requiresAllConditionallyShowOptionsPredicates` | No                         | `bool?`                                   | Whether all predicates must match for conditionally shown options.                                                                                                                                                                                                                                                                                                                          |               |
...
| `layout`                                 | No                                | `string`                                  | Repeatable set button layout. Allowed values are `"SINGLE_ADD_BUTTON"` and `"MULTIPLE_ADD_BUTTONS"`.                                                                                                                                                                                                                                                                                       |               |
...
| `autocompleteAttributes`                 | No                                | `List<string>`                            | Custom autocomplete attributes added to supported inputs during rendering.                                                                                                                                                                                                                                                                                                                  |               |
...
| `isHidden`                               | No                                | `bool?`                                   | Determine if the element is hidden (`true`) or not (`false`). Hidden elements exist on the page, but are not visible. This means they are included in conditional logic and other dependency evaluation and are included in the submission data. When `true` and `hiddenFrom` is omitted, the element is hidden from all audiences. When `true` and `hiddenFrom` is set, the element is hidden only from the listed audiences. |               |
| `hiddenFrom`                             | No                                | `List<string>`                            | Audiences to hide the element from when `isHidden` is `true`. Omitted means all audiences. Allowed values are `"SUBMITTER"` and `"APPROVER"`.                                                                                                                                                                                                                                              |               |
...
| `homeWidgetEnabled`                      | No                                | `bool`                                    | Show and allow the user to use the home widget.                                                                                                                                                                                                                                                                                                                                            |               |
| `decorativeImage`                        | No                                | `bool?`                                   | Whether the image element is decorative or not for screen readers.                                                                                                                                                                                                                                                                                                                         |               |
| `screenReaderAlert`                      | No                                | `bool?`                                   | When `true`, the html (information) element content will be announced to screen readers as an alert.                                                                                                                                                                                                                                                                                       |               |
| `includeTimestampWatermark`              | Yes for camera                    | `bool`                                    | Whether camera images include a timestamp watermark.                                                                                                                                                                                                                                                                                                                                        | `false`       |
...
| `reverseGeocoding`                       | No                                | `FormElementReverseGeocoding`             | Reverse-geocoding configuration containing `formattedAddressElementId` and `integrationType`.                                                                                                                                                                                                                                                                                               |               |
...
| `maxWidthPixels`                         | No                                | `int?`                                    | Max width, in pixels, to be used when the `image` element is rendered.                                                                                                                                                                                                                                                                                                                     |               |
| `entrySummary`                           | No                                | `string`                                  | HTML to display a summary of elements within the repeatable set entry.                                                                                                                                                                                                                                                                                                                     |               |
...
#### Point Address V3 Element

##### `FormElement.CreatePointAddressV3Element()`
...
```c#
FormElement pointAddressElement = FormElement.CreatePointAddressV3Element(
    "Point_test_element_v3",
    "Point test element_v3",
    "123"
);
```
