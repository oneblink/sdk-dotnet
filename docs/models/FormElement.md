...
| `conditionallyShowPredicates`            | No       | `List<FormElementConditionallyShowPredicate>` | List of elements to be used as conditions                                                                                                                                                                                                                                                                    | null          |
...
| `conditionallyShowPredicates`          | No       | `List<FormElementConditionallyShowPredicate>` | `null`        |
