...
namespace OneBlink.SDK
{
    internal class OneBlinkHttpClient
    {
        ...
        public string CreateQueryString(IDictionary<string, string> searchParams)
        {
            IEnumerable<string> array = searchParams.Select<KeyValuePair<string, string>, string>(
                keyValuePair => string.Join("=", keyValuePair.Key, keyValuePair.Value)
            );
